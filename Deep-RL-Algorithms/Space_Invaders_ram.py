...
config = Config()
config.seed = 1
config.environment_short_name = "SpaceInvaders"
config.save_every_n_steps = 10000
config.load_path = None
config.render = False
config.environment = make_atari_ram_game("SpaceInvaders-ram-v4", max_episode_steps=1000, render_mode=config.render)
